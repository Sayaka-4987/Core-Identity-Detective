...
const cases = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "manager", label: { en: "Manager Escalation", zh: "经理层级扩大" } },
  ...
  },
  {
    ...
    resultFlavor: {
      correct: { en: "Correct. 'We're a family' is Schrodinger's memo. Follow the telemetry — there is none.", zh: "正确。“我们是一家人”是薛定谔的备忘录。跟着数据走，而这次根本没有数据。" },
